"""FastAPI dependency injection — auth, pagination, current user."""
...
def get_current_user(
    ...
    """Verify the JWT Bearer token and return the authenticated user context.

    Raises 401 if the token is missing, expired, or has an invalid signature.
    The token is issued by auth-service and both services share the same JWT_SECRET.
    """
