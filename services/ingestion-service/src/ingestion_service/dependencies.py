"""FastAPI dependency injection — auth and current user.

Copied from project-service. Both services share the same JWT_SECRET so tokens
issued by auth-service are valid in both services.
"""
