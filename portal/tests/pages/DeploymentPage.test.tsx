...
describe("DeploymentPage", () => {
  it("renders Overview tab by default and shows stub URL", async () => {
    ...
    // CLAUDE.md's own product description promises "a URL + API key" — this
    // was generated by the backend but silently never shown until this fix.
  ...
  it("switches to Metrics History tab and shows range buttons", async () => {
    ...
    await userEvent.click(screen.getByRole("tab", { name: "Metrics History" }));
